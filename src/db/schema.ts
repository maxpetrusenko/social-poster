...
// ── Work-to-post (isolated from posts, replies, and scheduler) ───────
export const workCompletionEvents = sqliteTable("work_completion_events", {
  id: text("id").primaryKey(), workspaceId: text("workspace_id").notNull(), sourceAgent: text("source_agent").notNull(), externalEventId: text("external_event_id").notNull(), sessionRef: text("session_ref").notNull(), projectRef: text("project_ref").notNull(), summary: text("summary").notNull(), privacy: text("privacy").notNull(), status: text("status").notNull(), occurredAt: integer("occurred_at", { mode: "timestamp" }).notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull(),
}, (table) => [uniqueIndex("work_completion_events_replay_unique").on(table.workspaceId, table.sourceAgent, table.externalEventId)]);
export const workCompletionProofs = sqliteTable("work_completion_proofs", { id: text("id").primaryKey(), completionEventId: text("completion_event_id").notNull().references(() => workCompletionEvents.id, { onDelete: "cascade" }), type: text("type").notNull(), uri: text("uri").notNull(), hash: text("hash"), verifiedAt: integer("verified_at", { mode: "timestamp" }), createdAt: integer("created_at", { mode: "timestamp" }).notNull() });
export const contentCandidates = sqliteTable("content_candidates", { id: text("id").primaryKey(), workspaceId: text("workspace_id").notNull(), completionEventId: text("completion_event_id").notNull().references(() => workCompletionEvents.id, { onDelete: "cascade" }), status: text("status").notNull(), currentRevision: integer("current_revision").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull(), updatedAt: integer("updated_at", { mode: "timestamp" }).notNull() }, (table) => [uniqueIndex("content_candidates_completion_unique").on(table.workspaceId, table.completionEventId)]);
export const contentRevisions = sqliteTable("content_revisions", { id: text("id").primaryKey(), candidateId: text("candidate_id").notNull().references(() => contentCandidates.id, { onDelete: "cascade" }), revisionNumber: integer("revision_number").notNull(), contentDigest: text("content_digest").notNull(), mediaDigest: text("media_digest"), accountDigest: text("account_digest"), policyDigest: text("policy_digest"), assignedAccount: text("assigned_account"), policyVersion: text("policy_version"), approvalExpiresAt: integer("approval_expires_at", { mode: "timestamp" }), createdAt: integer("created_at", { mode: "timestamp" }).notNull() }, (table) => [uniqueIndex("content_revisions_number_unique").on(table.candidateId, table.revisionNumber)]);
export const contentLifecycleEvents = sqliteTable("content_lifecycle_events", { id: text("id").primaryKey(), workspaceId: text("workspace_id").notNull(), candidateId: text("candidate_id").notNull(), eventType: text("event_type").notNull(), revisionNumber: integer("revision_number").notNull(), traceRef: text("trace_ref"), createdAt: integer("created_at", { mode: "timestamp" }).notNull() }, (table) => [index("content_lifecycle_events_candidate_idx").on(table.workspaceId, table.candidateId, table.createdAt)]);
export const contentTraceLinks = sqliteTable("content_trace_links", { id: text("id").primaryKey(), candidateId: text("candidate_id").notNull(), stage: text("stage").notNull(), traceRef: text("trace_ref").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull() });
export const referenceExamples = sqliteTable("reference_examples", { id: text("id").primaryKey(), workspaceId: text("workspace_id").notNull(), sourceUrl: text("source_url").notNull(), author: text("author").notNull(), capturedAt: integer("captured_at", { mode: "timestamp" }).notNull(), mechanism: text("mechanism").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull() });
export const contentAngles = sqliteTable("content_angles", { id: text("id").primaryKey(), candidateId: text("candidate_id").notNull(), revisionNumber: integer("revision_number").notNull(), title: text("title").notNull(), provenance: text("provenance").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull() });
export const contentComments = sqliteTable("content_comments", { id: text("id").primaryKey(), candidateId: text("candidate_id").notNull(), revisionNumber: integer("revision_number").notNull(), body: text("body").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull() });
export const contentReviews = sqliteTable("content_reviews", { id: text("id").primaryKey(), candidateId: text("candidate_id").notNull().references(() => contentCandidates.id, { onDelete: "cascade" }), revisionNumber: integer("revision_number").notNull(), revisionDigest: text("revision_digest").notNull(), status: text("status").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull() }, (table) => [uniqueIndex("content_reviews_revision_digest_unique").on(table.candidateId, table.revisionNumber, table.revisionDigest)]);
export const contentDecisions = sqliteTable("content_decisions", { id: text("id").primaryKey(), workspaceId: text("workspace_id").notNull(), candidateId: text("candidate_id").notNull().references(() => contentCandidates.id, { onDelete: "cascade" }), commandType: text("command_type").notNull(), requestHash: text("request_hash").notNull(), approvalDigest: text("approval_digest"), dispatchId: text("dispatch_id"), createdAt: integer("created_at", { mode: "timestamp" }).notNull() }, (table) => [
  uniqueIndex("content_decisions_replay_unique").on(table.workspaceId, table.requestHash),
  uniqueIndex("content_decisions_approval_unique").on(table.workspaceId, table.approvalDigest).where(sql`approval_digest IS NOT NULL`),
]);
export const commandReceipts = sqliteTable("command_receipts", { id: text("id").primaryKey(), workspaceId: text("workspace_id").notNull(), operation: text("operation").notNull(), idempotencyKey: text("idempotency_key").notNull(), candidateId: text("candidate_id").notNull().references(() => contentCandidates.id, { onDelete: "cascade" }), revisionNumber: integer("revision_number").notNull(), commandType: text("command_type").notNull(), scopeDigest: text("scope_digest").notNull(), requestHash: text("request_hash").notNull(), state: text("state").notNull().default("processing"), leaseExpiresAt: integer("lease_expires_at", { mode: "timestamp" }), attempts: integer("attempts").notNull().default(1), response: text("response"), createdAt: integer("created_at", { mode: "timestamp" }).notNull(), updatedAt: integer("updated_at", { mode: "timestamp" }).notNull() }, (table) => [uniqueIndex("command_receipts_replay_unique").on(table.workspaceId, table.operation, table.idempotencyKey)]);
export const dispatchIntents = sqliteTable("dispatch_intents", { id: text("id").primaryKey(), workspaceId: text("workspace_id").notNull(), candidateId: text("candidate_id").notNull().references(() => contentCandidates.id, { onDelete: "cascade" }), action: text("action").notNull(), status: text("status").notNull(), requestHash: text("request_hash").notNull(), approvalDigest: text("approval_digest").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull() }, (table) => [uniqueIndex("dispatch_intents_approval_unique").on(table.workspaceId, table.approvalDigest)]);
export const learningProposals = sqliteTable("learning_proposals", { id: text("id").primaryKey(), workspaceId: text("workspace_id").notNull(), candidateId: text("candidate_id").notNull().references(() => contentCandidates.id, { onDelete: "cascade" }), status: text("status").notNull(), reasonCodes: text("reason_codes").notNull().default("[]"), scope: text("scope").notNull().default("candidate"), traitKey: text("trait_key"), direction: text("direction"), evidenceEventIds: text("evidence_event_ids").notNull().default("[]"), confidence: integer("confidence").notNull().default(0), expiresAt: integer("expires_at", { mode: "timestamp" }), createdAt: integer("created_at", { mode: "timestamp" }).notNull() }, (table) => [index("learning_proposals_candidate_idx").on(table.workspaceId, table.candidateId, table.createdAt)]);
export const learningRuleVersions = sqliteTable("learning_rule_versions", { id: text("id").primaryKey(), workspaceId: text("workspace_id").notNull(), proposalId: text("proposal_id").notNull().references(() => learningProposals.id, { onDelete: "cascade" }), versionNumber: integer("version_number").notNull(), status: text("status").notNull(), scope: text("scope").notNull().default("candidate"), trait: text("trait"), direction: text("direction"), evidence: text("evidence").notNull().default("[]"), confidence: integer("confidence").notNull().default(0), expiresAt: integer("expires_at", { mode: "timestamp" }), createdAt: integer("created_at", { mode: "timestamp" }).notNull() });
export const contentOutcomes = sqliteTable("content_outcomes", { id: text("id").primaryKey(), candidateId: text("candidate_id").notNull(), capturedAt: integer("captured_at", { mode: "timestamp" }).notNull(), metrics: text("metrics").notNull() });
export const personDossiers = sqliteTable("person_dossiers", { id: text("id").primaryKey(), workspaceId: text("workspace_id").notNull(), canonicalIdentityKey: text("canonical_identity_key").notNull(), displayName: text("display_name").notNull(), status: text("status").notNull(), currentVersion: integer("current_version").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull(), updatedAt: integer("updated_at", { mode: "timestamp" }).notNull() }, (table) => [uniqueIndex("person_dossiers_identity_unique").on(table.workspaceId, table.canonicalIdentityKey)]);
export const personDossierVersions = sqliteTable("person_dossier_versions", { id: text("id").primaryKey(), dossierId: text("dossier_id").notNull(), versionNumber: integer("version_number").notNull(), status: text("status").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull() }, (table) => [uniqueIndex("person_dossier_versions_number_unique").on(table.dossierId, table.versionNumber)]);
export const personDossierSources = sqliteTable("person_dossier_sources", { id: text("id").primaryKey(), dossierVersionId: text("dossier_version_id").notNull(), url: text("url").notNull(), kind: text("kind").notNull(), capturedAt: integer("captured_at", { mode: "timestamp" }).notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull() });
export const personDossierClaims = sqliteTable("person_dossier_claims", { id: text("id").primaryKey(), dossierVersionId: text("dossier_version_id").notNull(), statement: text("statement").notNull(), sourceUrls: text("source_urls").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull() });
export const personRelationshipEvents = sqliteTable("person_relationship_events", { id: text("id").primaryKey(), workspaceId: text("workspace_id").notNull(), dossierId: text("dossier_id").notNull(), eventType: text("event_type").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull() });
export const contentPersonDossiers = sqliteTable("content_person_dossiers", { id: text("id").primaryKey(), candidateId: text("candidate_id").notNull(), dossierVersionId: text("dossier_version_id").notNull(), createdAt: integer("created_at", { mode: "timestamp" }).notNull() });
